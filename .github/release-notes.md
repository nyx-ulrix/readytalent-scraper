...
| System | File |
| --- | --- |
| Windows 10/11 (64-bit) | `AutoResume-Setup-1.2.9-win-x64.exe` |
| macOS, Apple Silicon (M1 or later) | `AutoResume-1.2.9-mac-arm64.dmg` |
| macOS, Intel | `AutoResume-1.2.9-mac-x64.dmg` |
