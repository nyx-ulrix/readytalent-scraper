...
- **Paste a job posting (Search tab):** paste a posting's text from any site, or on the laptop app just its link, and press **✦ Add with AI** to fill in the title, company, pay and skills (or **Add without AI** and type the title yourself). It is saved with your jobs, ready to tailor a resume or cover letter for. Sites behind a bot check are not worked around: copy the text from your browser instead.
- **On any job:**
